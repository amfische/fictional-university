...
/* harmony import */ var _js_modules_MobileMenu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/modules/MobileMenu */ "./src/js/modules/MobileMenu.js");
/* harmony import */ var _js_modules_HeroSlider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/modules/HeroSlider */ "./src/js/modules/HeroSlider.js");
/* harmony import */ var _js_modules_GoogleMap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/modules/GoogleMap */ "./src/js/modules/GoogleMap.js");
/* harmony import */ var _js_modules_Search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/modules/Search */ "./src/js/modules/Search.js");
/* harmony import */ var _js_modules_MyNotes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/modules/MyNotes */ "./src/js/modules/MyNotes.js");
/* harmony import */ var _js_modules_Like__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/modules/Like */ "./src/js/modules/Like.js");
 // Our modules / classes
...
var mobileMenu = new _js_modules_MobileMenu__WEBPACK_IMPORTED_MODULE_1__["default"]();
var heroSlider = new _js_modules_HeroSlider__WEBPACK_IMPORTED_MODULE_2__["default"]();
var googleMap = new _js_modules_GoogleMap__WEBPACK_IMPORTED_MODULE_3__["default"]();
var search = new _js_modules_Search__WEBPACK_IMPORTED_MODULE_4__["default"]();
var myNotes = new _js_modules_MyNotes__WEBPACK_IMPORTED_MODULE_5__["default"]();
var like = new _js_modules_Like__WEBPACK_IMPORTED_MODULE_6__["default"]();
search.init();
myNotes.init();
like.init(); // Allow new JS and CSS to load in browser without a traditional page refresh
...
var GMap = /*#__PURE__*/function () {
  function GMap() {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, GMap);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(GMap, [{
    key: "new_map",
...
var HeroSlider = function HeroSlider() {
  ...
  if (document.querySelector(".hero-slider")) {
    ...
    var glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_1__["default"](".hero-slider", {
      type: "carousel",
      perView: 1,
      autoplay: 3000
    });
...
var Like = /*#__PURE__*/function () {
  function Like() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, Like);

    this.likeBtn = document.querySelector('.like-box');
    this.likeCount = document.querySelector('.like-count');
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Like, [{
    key: "init",
    value: function init() {
    ...
    value: function createLike() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("".concat(universityData.root_url, "/wp-json/university/v1/manage-like"), data, config).then(function (res) {
        _this.likeBtn.dataset.exists = 'yes';
        _this.likeCount.innerText = parseInt(_this.likeCount.innerText, 10) + 1;
    ...
    value: function deleteLike() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.delete("".concat(universityData.root_url, "/wp-json/university/v1/manage-like"), config).then(function (res) {
        _this2.likeBtn.dataset.exists = 'no';
        _this2.likeCount.innerText = parseInt(_this2.likeCount.innerText, 10) - 1;
...
var MyNotes = /*#__PURE__*/function () {
  function MyNotes() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, MyNotes);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(MyNotes, [{
    key: "init",
    value: function init() {
    ...
    value: function deleteNote(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.delete("".concat(universityData.root_url, "/wp-json/wp/v2/note/").concat(noteNode.dataset.id), config).then(function (res) {
        noteNode.classList.add('fade-out');

        if (res.data.user_note_count < 5) {
          _this.noteLimitMsg.classList.remove('active');
        }
    ...
    key: "toggleNoteEditor",
    value: function toggleNoteEditor(e) {
      var noteNode = e.target.closest('li');
    ...
    value: function updateNote(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.put("".concat(universityData.root_url, "/wp-json/wp/v2/note/").concat(noteNode.dataset.id), data, config).then(function (res) {
        _this2.toggleNoteEditor(e);
    ...
    value: function createNote(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("".concat(universityData.root_url, "/wp-json/wp/v2/note"), data, config).then(function (res) {
        _this3.newNote.title.value = '';
        _this3.newNote.content.value = '';

        _this3.notesList.insertAdjacentHTML("afterbegin", " <li data-id=\"".concat(res.data.id, "\" class=\"fade-in-calc\">\n            <input readonly class=\"note-title-field\" value=\"").concat(res.data.title.raw, "\">\n            <span class=\"edit-note\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i> Edit</span>\n            <span class=\"delete-note\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i> Delete</span>\n            <textarea readonly class=\"note-body-field\">").concat(res.data.content.raw, "</textarea>\n            <span class=\"update-note btn btn--blue btn--small\"><i class=\"fa fa-arrow-right\" aria-hidden=\"true\"></i> Save</span>\n          </li>"));

        var newNoteNode = document.querySelector("li[data-id=\"".concat(res.data.id, "\"]"));
        setTimeout(function () {
        ...
        if (err.response.data.data.msg === 'You have reached your note limit.') {
          _this3.noteLimitMsg.classList.add('active');
        }
...
var Search = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Search, [{
    ...
    value: function init() {
      ...
      this.openButtons.forEach(function (btn) {
        return btn.addEventListener('click', _this.openOverlay.bind(_this));
      });
    ...
    value: function getResults() {
      ...
      fetch(universityData.root_url + '/wp-json/university/v1/search?term=' + this.inputField.value.trim()).then(function (res) {
        return res.json();
      }).then(function (res) {
        _this2.resultsDiv.innerHTML = "\n        <div class=\"row\">\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">General Information</h2>\n            ".concat(res.generalInfo.length === 0 ? "<p>No general information matches that search</p>" : "<ul class=\"link-list min-list\">\n                ".concat(res.generalInfo.map(function (item) {
          return "\n                  <li><a href=\"".concat(item.link, "\">").concat(item.title, "</a> ").concat(item.type === 'post' ? "by ".concat(item.author_name) : '', "</li>\n                ");
        }).join(''), "\n              </ul>"), "\n          </div>\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Programs</h2>\n            ").concat(res.programs.length === 0 ? "<p>No programs match that search. <a href=\"".concat(universityData.root_url, "/programs\">View all programs.</a></p>") : "<ul class=\"link-list min-list\">\n                ".concat(res.programs.map(function (item) {
          return "<li><a href=\"".concat(item.link, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n              </ul>"), "\n            <h2 class=\"search-overlay__section-title\">Professors</h2>\n            ").concat(res.professors.length === 0 ? "<p>No professors match that search.</p>" : "<ul class=\"professor-cards\">\n                ".concat(res.professors.map(function (item) {
          return "\n                  <li class=\"professor-card__list-item\">\n                    <a class=\"professor-card\" href=\"".concat(item.link, "\">\n                      <img class=\"professor-card__image\" src=\"").concat(item.thumbnail_url, "\">\n                      <span class=\"professor-card__name\">").concat(item.title, "</span>\n                    </a>\n                  </li>\n                ");
        }).join(''), "\n              </ul>"), "\n          </div>\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Campuses</h2>\n            ").concat(res.campuses.length === 0 ? "<p>No campuses match that search. <a href=\"".concat(universityData.root_url, "/campuses\">View all campuses.</a></p>") : "<ul class=\"link-list min-list\">\n                ".concat(res.campuses.map(function (item) {
          return "<li><a href=\"".concat(item.link, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n              </ul>"), "\n            <h2 class=\"search-overlay__section-title\">Events</h2>\n            ").concat(res.events.length === 0 ? "<p>No events match that search. <a href=\"".concat(universityData.root_url, "/events\">View all events.</a></p>") : "<ul class=\"link-list min-list\">\n                ".concat(res.events.map(function (item) {
          return "\n                  <div class=\"event-summary\">\n                    <a class=\"event-summary__date t-center\" href=\"".concat(item.link, "\">\n                      <span class=\"event-summary__month\">").concat(item.month, "</span>\n                      <span class=\"event-summary__day\">").concat(item.day, "</span>\n                    </a>\n                    <div class=\"event-summary__content\">\n                      <h5 class=\"event-summary__title headline headline--tiny\"><a href=\"").concat(item.link, "\">").concat(item.title, "</a></h5>\n                      <p>").concat(item.description, "<a href=\"").concat(item.link, "\" class=\"nu gray\"> Learn more</a></p>\n                    </div>\n                  </div>\n                ");
        }).join(''), "\n              </ul>"), "\n          </div>\n        </div>\n      ");
        _this2.fetchingResults = false;
